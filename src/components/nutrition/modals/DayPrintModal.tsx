...
export default function DayPrintModal({
  ...
  const dayNotesHtml = sanitizeNutritionHtml(day.notes);
        ...
        <div className="day-print-content-wrapper">
          ...
          <div className="day-printable-content p-6">
            ...
            {day.meals && day.meals.length > 0 ? (
              day.meals.map((workout: any, workoutIdx: number) => {
                    ...
                    <div className="bg-blue-600 text-white px-4 py-2 rounded-t">
                      <div className="flex items-center justify-between">
                        <span className="text-lg font-bold">
                          🏋️ NutritionMeal {workoutIdx + 1}: {workout.name || `Workout ${workout.sessionNumber || ''}`}
                        </span>
                        {activeSection !== 'A' && day && (
