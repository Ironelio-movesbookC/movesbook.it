...
export function suggestedRoutineTotalSeriesForDistMask(params: {
  ...
  if (fromSettings) {
    ...
    const deltaPct = readVolumeDeltaPctFromNutritionSettings(params.trainingLevel, d);
...
export default function PlanGymWeekManualModal({
  ...
  const hasSavedGoalParams = readGoalParamsFromNutritionSettings(activeGoalForStats) != null;
          ...
          <div className="min-w-0 flex-1">
            ...
            {initialPlan?.days?.length ? (
              <p className="mt-0.5 text-xs text-amber-700">
                Suggested routines and muscular areas from your choices. You can freely change them manually (add, remove, reorder, edit parameters), then Create routines and nutritionComponents.
              </p>
            ) : null}
          </div>
