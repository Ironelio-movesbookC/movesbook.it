        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <p className="text-xs text-gray-600 mt-1">
              This will copy all workouts, nutritionFoods, and nutrition_components from Week {sourceWeek.weekNumber} to the selected target week(s).
            </p>
          </div>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
            <p className="text-xs text-yellow-800">
              <strong>âš ï¸ Note:</strong> This will copy all workouts, nutritionFoods, and nutrition_components from the source week to {selectedCount} target week(s). Day-specific info (date, notes) will remain unchanged in the target weeks.
            </p>
          </div>
        </div>
