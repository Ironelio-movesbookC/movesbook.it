    ...
    >
      ...
      <td className="border border-gray-200 px-1 py-1 text-xs text-left bg-blue-100 text-black">
        {sportSummaries[0] ? (
          <div className="flex items-center justify-start gap-2">
            {useImageIcons ? (
              <Image src={sportSummaries[0].icon} alt={sportSummaries[0].sport} width={40} height={40} className="object-cover rounded flex-shrink-0" unoptimized />
            ) : (
      ...
      <td className="border border-gray-200 px-1 py-1 text-xs text-left bg-green-100 text-black">
        {sportSummaries[1] ? (
          <div className="flex items-center justify-start gap-2">
            {useImageIcons ? (
              <Image src={sportSummaries[1].icon} alt={sportSummaries[1].sport} width={40} height={40} className="object-cover rounded flex-shrink-0" unoptimized />
            ) : (
      ...
      <td className="border border-gray-200 px-1 py-1 text-xs text-left bg-orange-100 text-black">
        {sportSummaries[2] ? (
          <div className="flex items-center justify-start gap-2">
            {useImageIcons ? (
              <Image src={sportSummaries[2].icon} alt={sportSummaries[2].sport} width={40} height={40} className="object-cover rounded flex-shrink-0" unoptimized />
            ) : (
      ...
      <td className="border border-gray-200 px-1 py-1 text-xs text-left bg-pink-100 text-black">
        {sportSummaries[3] ? (
          <div className="flex items-center justify-start gap-2">
            {useImageIcons ? (
              <Image src={sportSummaries[3].icon} alt={sportSummaries[3].sport} width={40} height={40} className="object-cover rounded flex-shrink-0" unoptimized />
            ) : (
