/**
 * NutritionFood Constants
 * Extracted from AddEditNutritionFoodModal.tsx for better maintainability
 */
...
/** Circuit planner "Macro" / Continuous Time digit (0–9) → nutritionFood `macroFinal` label */
 ...
 * These sports need a nutritionFood input form dedicated to aerobic activities
 ...
 * These sports need a nutritionFood input form dedicated to non-aerobic activities
 ...
 * These sports need a nutritionFood input form dedicated to technical activities
 ...
 * (see Add NutritionFood: “Fast & circuits” + Circuits). Not the same as category A aerobic grids.
 */
...
export type NutritionFoodType = 'STANDARD' | 'BATTERY' | 'ANNOTATION';
...
// Helper function to format nutritionFood type for display
export function formatNutritionFoodType(type: string): string {
  if (type === 'STANDARD') {
