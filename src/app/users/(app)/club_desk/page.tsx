      ...
      <div className="flex w-full flex-1 flex-col py-2">
        ...
        <div className="flex flex-1 gap-0">
          ...
          <div className="min-w-0 flex-1 flex-col py-2">
            {clubId ? (
              <MyDeskSettingsTree clubId={clubId} headingKey="sidebar_club_desk" />
            ) : (
              <div className="px-4 py-8 text-center text-sm text-zinc-600">
                Select a club to manage Club Desk.
              </div>
            )}
          </div>
...
/** Club Desk settings — club admins only (including ID5–ID9 when they are adminId). */
export default function ClubDeskSettingsPage() {
  return (
    <Suspense fallback={null}>
      <ClubDeskSettingsInner />
    </Suspense>
  );
}
