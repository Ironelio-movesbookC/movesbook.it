...
async function assertGroupOwner(groupId: string, userId: string): Promise<boolean> {
...
export async function PATCH(
  ...
  try {
    ...
    if (!(await assertGroupOwner(groupId, userId))) {
    ...
    console.error('PATCH /api/groups/[groupId]:', e);
