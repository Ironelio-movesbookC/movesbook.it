          ...
          <form onSubmit={handleSubmit} className="px-6 py-5 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center gap-4">
                <label className="w-40 text-sm font-semibold text-gray-800">Username</label>
              ...
              <div className="flex items-center gap-4">
                <label className="w-40 text-sm font-semibold text-gray-800">Password</label>
                <div className="flex-1">
                  <input
                    type="password"
                    value={form.password}
              ...
              <div className="flex items-center gap-4">
                <label className="w-40 text-sm font-semibold text-gray-800">Retype Password</label>
                <div className="flex-1">
                  <input
                    type="password"
              ...
              <div className="flex items-center gap-4">
                <label className="w-40 text-sm font-semibold text-gray-800">Name</label>
                <div className="flex-1">
              ...
              <div className="flex items-center gap-4">
                <label className="w-40 text-sm font-semibold text-gray-800">SurName</label>
                <div className="flex-1">
