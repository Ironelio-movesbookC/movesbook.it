...
const sportBanners: SportBanner[] = [
  {
    id: 1,
    sport: "Athletic",
  ...
  },
  {
    id: 4,
    sport: "Athletic",
    banner: "/images/banners/athletic-4.jpg",
  },
  {
    id: 5,
    sport: "American football",
    banner: "/images/banners/american-football.jpg",
  },
];
  ...
  return (
    <main className="min-h-screen bg-white px-[33px] py-[15px] font-sans text-[14px] text-[#333]">
      ...
      <div className="flex items-start justify-between">
        ...
        <Link
          href="/admin/global-settings/sport-banners/new"
              ...
              >
                ...
                <td className="px-[110px] align-top pt-[10px]">
                  <div className="flex items-center gap-[22px]">
                    <Link
                      href={`/admin/global-settings/sport-banners/${item.id}/edit`}
                      aria-label={`Edit ${item.sport}`}
