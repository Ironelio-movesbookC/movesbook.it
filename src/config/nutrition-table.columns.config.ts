 ...
 * Defines editable column structures for Workout, NutritionFood, and NutritionComponent tables
 */
...
export const DEFAULT_MOVEFRAME_COLUMNS: ColumnConfig[] = [
  ...
  },
  {
    ...
    align: 'center',
    visible: true,
    dataKey: 'nutrition_components.length'
  },
  {
    id: 'total_distance',
    label: 'Dist/Dur',
...
export const COLUMN_CONFIG_STORAGE_KEYS = {
  ...
  MOVEFRAME: 'nutritionFood_table_columns',
  MOVELAP: 'nutritionComponent_table_columns'
} as const;
