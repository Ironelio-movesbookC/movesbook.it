...
export const createCourseSubscriptionRecordSchema = z.object({
...
export type CreateCourseSubscriptionRecordPayload = z.infer<typeof createCourseSubscriptionRecordSchema>;

export function mapCourseSubscriptionCreateToInput(
  data: CreateCourseSubscriptionRecordPayload
